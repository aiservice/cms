...
columns_table.push({
    title: '网站权重', field: 'site_rank', align: 'left', visible: false,
    shown: true, type: 'input', child_type: 'text', required: true, maxlength: 1
});
columns_table.push({
    title: '网站收录', field: 'site_in_num', align: 'left', visible: false,
    shown: true, type: 'input', child_type: 'text', required: true, maxlength: 11
});
columns_table.push({
    title: '域名年龄', field: 'site_age', align: 'left', visible: false,
    shown: true, type: 'input', child_type: 'text', required: true, maxlength: 11
});
columns_table.push({
